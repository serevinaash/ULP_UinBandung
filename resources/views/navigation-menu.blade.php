    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->roles == 'ADMIN')
                <x-jet-nav-link href="{{ route('dashboard.konseling') }}" :active="request()->routeIs('dashboard.product.index')">
                    {{ __('Products') }}
                </x-jet-nav-link>
                <x-jet-nav-link href="{{ route('dashboard.psikotes') }}" :active="request()->routeIs('dashboard.transaction.index')">
                    {{ __('Transactions') }}
                </x-jet-nav-link>
                <x-jet-nav-link href="{{ route('dashboard.ujikom') }}" :active="request()->routeIs('dashboard.user.index')">
                    {{ __('Users') }}
                </x-jet-nav-link>
             @endif
             <x-jet-nav-link href="{{ route('dashboard.my-transaction.index') }}" :active="request()->routeIs('dashboard.my-transaction.index')">
