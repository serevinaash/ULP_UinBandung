        ...
        <div class="row">
            <div class="col-md-5 col-sm-2">
                <div class="about-info">
                    ...
                    <div class="d-flex justify-content-start"> <!-- Added div with class "d-flex justify-content-start" -->
                        <img src="../images/uji.svg" alt="thinking" class="img-uji">
                    </div>
              </div>
            </div>  
            <div class="col-md-5 col-sm-6">
                <p class="uji">Tes Uji Kompetensi UIN Sunan Gunung Djati Bandung bekerja sama dengan Lembaga Sertifikasi Profesi Psikologi Indonesia (LSPPSI) akan menyelenggarakan Ujian Kompetensi Sertifikasi BNSP untuk 7 Skema Standar Kompetensi Kerja Khusus Profesi Psikologi.</p>
            </div>
        </div>
    </div>
</section>
...
<section id="ujikompetensi" data-stellar-background-ratio="2">
    <div class="container mx-auto">
        <div class="row">
            <div class="col-md-12 text-center">
                <h4 class="wow fadeInUp" data-wow-delay="1.6s">Seluruh peserta uji kompetensi diwajibkan membawa berkas-berkas berikut:</h4>
            </div>
            <div class="col-md-12 text-center"> <!-- Add a column for buttons -->
                ...
                <button class="read-more">CV Pengalaman kerja di bidang skema yang dipilih selama minimal 5 tahun</button>
    ...
    <section id="ujikompetensi" data-stellar-background-ratio="2">
        ...
        <div class="team-thumb2 wow fadeInUp" data-wow-delay="0.8s">
            ...
            <div class="team-info text-center">
                <a href="Register/RegisterUjiKompetensi.html"><button class="custom-button">Daftar Uji Kompetensi</button></a>
