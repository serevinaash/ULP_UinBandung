...
<body>
    <div class="container">
        ...
        <div id="step2" style="display: none">
            ...
            <form action="">
                ...
                <input type="text" id="alamatTinggal" name="alamatTinggal" placeholder="Alamat Tinggal" required />
                <label for="registrationType">
                    <select id="registrationType" name="registrationType" class="form-control" required>
        ...
        <div id="step4" style="display: none">
            ...
            <form action="">
                ...
                <input type="text" id="KonfirmasiPassword" name="KonfirmasiPassword"
    ...
    <button onclick="nextStep()">Berikutnya</button>
        ...
        function submitForm() {
            ...
            // You can also check password match again before submitting
            var password = document.getElementById("Password").value;
            var confirmPassword = document.getElementById("KonfirmasiPassword").value;
